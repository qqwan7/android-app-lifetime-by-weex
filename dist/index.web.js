...
Component.options.__file = "E:\\qqwan\\projects\\IPVT_Agent\\android-apps\\weex-app\\src\\components\\List.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-737524c0", Component.options)
  } else {
    hotAPI.reload("data-v-737524c0", Component.options)
  }
...
var update = __webpack_require__(3)("c7d78dd0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-737524c0\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./List.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-737524c0\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./List.vue");
...
// module
exports.push([module.i, "\n.flex[data-v-737524c0] {\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: flex;\n    flex-direction: row;\n    flex-wrap: wrap;\n}\n.item[data-v-737524c0] {\n    width: 0.2rem;\n    height: 0.2rem;\n    border-width: 1px;\n    border-style: solid;\n    border-color: rgb(255, 255, 255);\n    background-color: #b9c7da;\n}\n.item-big[data-v-737524c0] {\n    width: 0.4rem;\n    height: 0.4rem;\n}\n.item-small[data-v-737524c0] {\n    width: 0.13333rem;\n    height: 0.13333rem;\n}\n.item-pass[data-v-737524c0] {\n    background-color: #b9c7da;\n}\n.item-next[data-v-737524c0] {\n    background-color: #41c57c;\n}\n", ""]);
...
exports.default = {
    ...
    methods: {
        ...
        getPassNum: function getPassNum() {
            var birth = this.setDate(this.birthday);
            var birthYear = parseInt(this.birthday.substring(0, 4));
            var targetYear = birthYear + this.targetAge;
            var target = this.setDate(targetYear + this.birthday.substring(4, this.birthday.length));
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("致亲爱的您：截止今日" + _vm._s(_vm.curDate) + ",您已经走过了" + _vm._s(_vm.passNum) + _vm._s(_vm.type === 'day' ? '天' : _vm.type === 'month' ? '月' : _vm.type === 'week' ? '周' : '年') + "。未来还有" + _vm._s(_vm.nextNum) + _vm._s(_vm.type === 'day' ? '天' : _vm.type === 'month' ? '月' : _vm.type === 'week' ? '周' : '年') + "等着您去创造，且行且珍惜！\n    ")]), _vm._v(" "), _c('div', {
    staticClass: "flex weex-ct weex-div",
    attrs: {
      "weex-type": "div"
    }
  }, [_vm._l((_vm.passNum), function(n) {
    return (_vm.passNum > 0) ? _c('div', {
      key: 'pass' + n,
      staticClass: "item item-pass weex-ct weex-div",
      class: [_vm.type === 'year' ? 'item-big' : _vm.type === 'week' || _vm.type === 'day' ? 'item-small' : ''],
      attrs: {
        "weex-type": "div"
      }
    }) : _vm._e()
  }), _vm._v(" "), _vm._l((_vm.nextNum), function(n) {
    return (_vm.nextNum > 0) ? _c('div', {
      key: n,
      staticClass: "item item-next weex-ct weex-div",
      class: [_vm.type === 'year' ? 'item-big' : _vm.type === 'week' || _vm.type === 'day' ? 'item-small' : ''],
      attrs: {
        "weex-type": "div"
      }
  ...
  }, [_vm._v("无敌是多么多么寂寞。。。qqwan")])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-737524c0", module.exports)
  }
}
...
Component.options.__file = "E:\\qqwan\\projects\\IPVT_Agent\\android-apps\\weex-app\\src\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
