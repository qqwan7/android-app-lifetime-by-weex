...
__vue_options__.__file = "E:\\qqwan\\projects\\IPVT_Agent\\android-apps\\weex-app\\src\\components\\List.vue"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('text', [_vm._v("致亲爱的您：截止今日" + _vm._s(_vm.curDate) + ",您已经走过了" + _vm._s(_vm.passNum) + _vm._s(_vm.type === 'day' ? '天' : _vm.type === 'month' ? '月' : _vm.type === 'week' ? '周' : '年') + "。未来还有" + _vm._s(_vm.nextNum) + _vm._s(_vm.type === 'day' ? '天' : _vm.type === 'month' ? '月' : _vm.type === 'week' ? '周' : '年') + "等着您去创造，且行且珍惜！\n    ")]), _c('div', {
    staticClass: ["flex"]
  }, [_vm._l((_vm.passNum), function(n) {
    return (_vm.passNum > 0) ? _c('div', {
      key: 'pass' + n,
      staticClass: ["item", "item-pass"],
      class: [_vm.type === 'year' ? 'item-big' : _vm.type === 'week' || _vm.type === 'day' ? 'item-small' : '']
    }) : _vm._e()
  }), _vm._l((_vm.nextNum), function(n) {
    return (_vm.nextNum > 0) ? _c('div', {
      key: n,
      staticClass: ["item", "item-next"],
      class: [_vm.type === 'year' ? 'item-big' : _vm.type === 'week' || _vm.type === 'day' ? 'item-small' : '']
    }) : _vm._e()
  })], 2), _c('text', [_vm._v("无敌是多么多么寂寞。。。qqwan")])])
},staticRenderFns: []}
...
__vue_options__.__file = "E:\\qqwan\\projects\\IPVT_Agent\\android-apps\\weex-app\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
